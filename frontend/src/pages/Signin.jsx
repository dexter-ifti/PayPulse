...
function Signin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Tokens are now in httpOnly cookies; keep a flag for client-side UX
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="space-y-4 mt-6">
              ...
              <div className='text-left'>
                ...
                {passwordError && (
                  <p id="signin-password-error" role="alert" className="mt-1.5 text-xs text-red-400 flex items-center gap-1 motion-safe:animate-[fadeSlideIn_0.2s_ease-out]">
            ...
            <div className="pt-6">
              <Button type="submit" loading={submitting} label={submitting ? "Signing in…" : "Sign in"} />
            </div>
          </form>
